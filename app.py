# app.py — عربي سايكو: AI + DSM5 إرشادي + CBT مُبسّط + اختبارات موسّعة + اضطرابات الشخصية + تحويل طبي
...
# ذكاء اصطناعي (OpenRouter أو OpenAI)
...
PD_TEXT = (
    ...
    "🔸 للاسترشاد استخدم SAPAS وMSI-BPD من «الاختبارات النفسية». النتائج ليست تشخيصًا."
)
...
async def cmd_version(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "أزرار القائمة: عربي سايكو / CBT / اختبارات / اضطرابات / تحويل طبي",
        reply_markup=TOP_KB
    )
...
async def top_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if has("عربي سايكو", t):
        ...
        await update.message.reply_text(
            ...
            "ملاحظة: الردود دعمٌ تعليمي/سلوكي وليست تشخيصًا طبيًا.",
            reply_markup=kb
        )
        return MENU
