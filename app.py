...
# سنسجّل الهاندلرز قبل بدء اللوب
# (تُعرَّف الدوال لاحقًا في الملف)
def _register_handlers():
    conv = ConversationHandler(
        ...
        states={
            MENU: [
                ...
                CallbackQueryHandler(start_ai_cb, pattern="^(start_ai|ai_dsm)$"),
            ],
    ...
    tg_app.add_handler(CommandHandler("ai_diag", cmd_ai_diag))  # تشخيص إعدادات الذكاء
_register_handlers()

# اللوب الخلفي + ضبط الWebhook
